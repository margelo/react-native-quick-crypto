...
<img alt="react-native-quick-crypto" src="/static/img/banner-light.png" className="block dark:hidden" />
<img alt="react-native-quick-crypto" src="/static/img/banner-dark.png" className="hidden dark:block" />
...
<Cards>
  <Card
    ...
    description="Up to 100x faster than standard native bridges using JSI."
  />
  <Card
    icon={<Server />}
