...
export const COVERAGE_DATA: CoverageCategory[] = [
    {
        ...
        items: [
            { name: 'ML-DSA (Digital Signatures)', status: 'implemented', note: 'ML-DSA-44, 65, 87' },
            { name: 'ML-KEM (Key Encapsulation)', status: 'implemented', note: 'ML-KEM-512, 768, 1024' }
        ]
    },
    {
    ...
    },
    {
        ...
        items: [
            ...
            { name: 'timingSafeEqual', status: 'missing' }
        ]
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                subItems: [
                    ...
                    { name: 'ChaCha20-Poly1305', status: 'missing', note: 'Not implemented' },
                    { name: 'ECDH', status: 'partial', note: 'spki, pkcs8, jwk, raw, raw-public' },
                    { name: 'ECDSA', status: 'partial', note: 'spki, pkcs8, jwk, raw, raw-public' },
                    ...
                    { name: 'ML-DSA-44', status: 'partial', note: 'spki, pkcs8, jwk, raw-public, raw-seed' },
                    { name: 'ML-DSA-65', status: 'partial', note: 'spki, pkcs8, jwk, raw-public, raw-seed' },
                    { name: 'ML-DSA-87', status: 'partial', note: 'spki, pkcs8, jwk, raw-public, raw-seed' },
                    ...
                    { name: 'RSASSA-PKCS1-v1_5', status: 'partial', note: 'spki, pkcs8, jwk' }
                ]
            },
            {
            ...
            },
            {
                ...
                subItems: [
                    ...
                    { name: 'RSA-PSS', status: 'partial', note: 'spki, pkcs8, jwk' },
                    { name: 'RSASSA-PKCS1-v1_5', status: 'partial', note: 'spki, pkcs8, jwk' },
                    { name: 'X25519', status: 'partial', note: 'spki, pkcs8, jwk, raw, raw-public' },
                    { name: 'X448', status: 'partial', note: 'spki, pkcs8, jwk, raw, raw-public' }
                ]
            },
            {
