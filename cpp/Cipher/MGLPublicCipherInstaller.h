...
FieldDefinition getPublicCipherFieldDefinition(
  ...
  return buildPair(
      name, JSIF([=]) {
        ...
        if (!pkey) {
          throw jsi::JSError<jsi::JSError>(runtime, "Could not generate key");
        ...
        if (!CheckSizeInt32(runtime, buf)) {
          throw jsi::JSError<jsi::JSError>(runtime, "Data buffer is too long");
        ...
        if (!padding) {
          throw jsi::JSError<jsi::JSError>(runtime, "Invalid padding");
        ...
        if (arguments[offset + 2].isString()) {
          ...
          if (digest == nullptr) {
            throw jsi::JSError<jsi::JSError>(runtime, "Invalid digest (oaep_str)");
        ...
        if (!arguments[offset + 3].isUndefined()) {
          ...
          if (!CheckSizeInt32(runtime, oaep_label_buffer)) {
            throw jsi::JSError<jsi::JSError>(runtime, "oaep_label buffer is too long");
        ...
        if (!out.has_value()) {
          throw jsi::JSError<jsi::JSError>(runtime, "Failed to decrypt");
