...
//         EVP_PKEY_CTX_set_rsa_pss_keygen_md(ctx.get(), params->params.md) <=
//         0) {
//       return EVPKeyCtxPointer();
//     }
...
//       if (params->params.md == nullptr) {
//         THROW_ERR_CRYPTO_INVALID_DIGEST(env, "md specifies an invalid
//         digest"); return Nothing<bool>();
//       }
//     }
...
//   // TODO(tniessen): Remove the "else" branch once we drop support for
//   OpenSSL
...
//                     e.ToBN().release(),
//                     nullptr)) {
//                       THROW_ERR_CRYPTO_INVALID_JWK(env, "Invalid JWK RSA
//                       key"); return std::shared_ptr<KeyObjectData>();
//                     }
...
//     ByteSource dp = ByteSource::FromEncodedString(env,
//     dp_value.As<String>()); ByteSource dq =
//     ByteSource::FromEncodedString(env, dq_value.As<String>()); ByteSource qi
//     = ByteSource::FromEncodedString(env, qi_value.As<String>());
...
//                              dq.ToBN().release(),
//                              qi.ToBN().release())) {
//                                THROW_ERR_CRYPTO_INVALID_JWK(env, "Invalid JWK
//                                RSA key"); return
//                                std::shared_ptr<KeyObjectData>();
//                              }
//   }
...
//   return KeyObjectData::CreateAsymmetric(type,
...
//     // default values, an empty sequence will be stored in the ASN.1
//     structure.
//     // In that case, RSA_get0_pss_params does not return nullptr but all
//     fields
...
//       // If, for some reason, the MGF is not MGF1, then the MGF1 hash
//       function
...
//           ThrowCryptoError(env, ERR_get_error(), "ASN1_INTEGER_get_in64
//           error"); return Nothing<bool>();
//         }
//       }
...
//                 static_cast<double>(salt_length)))
//           .IsNothing()) {
//             return Nothing<bool>();
//           }
//     }
